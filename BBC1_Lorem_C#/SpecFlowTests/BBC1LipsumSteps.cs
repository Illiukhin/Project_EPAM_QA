...
namespace BBC1withLoremIpsum.SpecFlowTests
{
    ...
    public class BBC1LipsumSteps
    {
        ...
        {
            _webDriver.Navigate().GoToUrl(DataContext.TestUrl[page]);
        }
        ...
        public void WhenUserGeneratesTextWithLorem(int times)
        {
            var loremHome = new LoremHome(_webDriver);
            DataContext.AverageNumberLorem = loremHome.GeneratorInQuantity(times);
        }
        ...
        {
            Assert.IsTrue(DataContext.AverageNumberLorem >= number);
        }
        ...
        public void GivenUserGeneratesTheTextOfTheQuestion()
        {
            ...
            DataContext.Question =  basePage.GenerateLoremQuestion();
        }
    }
}
